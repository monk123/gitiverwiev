        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a charset="UTF-8" href="#"><spring:message code="header.locale.ru"/></a> </li>
                    <li><a href="?locale=en"><spring:message code="header.locale.en"/></a></li>
                    </c:if>
                    </li>
                    <li>
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <security:authorize access="isAuthenticated()">
                            <p class="navbar-text">Hello, <security:authentication property="principal.displayName"/></p>
                                <c:url value="/logout" var="/j_spring_security_logout"/>
                                    <li class="active">
                ...
                <div id="category-options" class="list-group">
                    <c:if test="${not empty categories}">
                        <c:forEach var="product" items="${categories}">
                            <a href="<c:url value='/product/${product}' />" class="list-group-item category-select-option" data-category-name="${product}">${product}</a>
                        </c:forEach>
                    </c:if>
                </div>
            </div>
